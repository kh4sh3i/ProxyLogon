...
def help():
    cout << f"""usage:
    python {__file__} --host=target.com --mail=admin@target.com
    python {__file__} --host=target.com --mails=./mails.txt
    """
    cout << endl
...
def Logo():
    return ''' 
                            _                         
  _ __  _ __ _____  ___   _| | ___   __ _  ___  _ __  
 | '_ \| '__/ _ \ \/ / | | | |/ _ \ / _` |/ _ \| '_ \ 
 | |_) | | | (_) >  <| |_| | | (_) | (_| | (_) | | | |
 | .__/|_|  \___/_/\_\\\__, |_|\___/ \__, |\___/|_| |_|
 |_|                  |___/         |___/             
